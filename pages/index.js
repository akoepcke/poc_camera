        ...
        <Tab.Panels>
          ...
          <div className="grid items-center w-full gap-4">
            ...
            <div className="grid grid-cols-[1fr,auto] gap-2">
              ...
              <div>selectedOn</div><div className="break-all">{videoMeta?.selectedOn}</div>
              <div>selectedOnFormat</div><div className="break-all">{videoMeta?.selectedOn ? moment(videoMeta?.selectedOn).format("DD.MM.YYYY - HH:mm:ss"): ""}</div>
          ...
          <div className="flex justify-between">
            ...
            <div className="grid grid-cols-[1fr,auto] gap-2">
              ...
              <div>selectedOn</div><div className="break-all">{photoMeta?.selectedOn}</div>
              <div>selectedOnFormat</div><div className="break-all">{photoMeta?.selectedOn ? moment(photoMeta?.selectedOn).format("DD.MM.YYYY - HH:mm:ss"): ""}</div>
